...
<body
    ...
    <footer style="
        ...
        <a href="{{ url('/') }}" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;">
            <span
                style="width:26px;height:26px;background:linear-gradient(135deg,#1E6F5C,#2C2C2C);border-radius:7px;display:flex;align-items:center;justify-content:center;">
            ...
            <span style="font-size:0.92rem;font-weight:700;color:#fff;">Lúdika</span>
        </a>
        <p style="color:rgba(255,255,255,0.40);font-size:0.78rem;margin:0;">
            &copy; {{ date('Y') }} Lúdika &nbsp;·&nbsp; Hecho con <span style="color:#C9A227;">♥</span> en
            México
        </p>
    </footer>
</body>
